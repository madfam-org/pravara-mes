...
// PrusaMiniPlusDefinition returns the machine definition for the Prusa MINI+.
func PrusaMiniPlusDefinition() *MachineDefinition {
	return &MachineDefinition{
		...
		Capabilities: map[string]interface{}{
			...
			"materials": map[string]interface{}{
				"materials": []string{"PLA", "PETG", "ASA", "ABS", "FLEX"},
			},
		},
