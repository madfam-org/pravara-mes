...
// Voron24Definition returns the machine definition for the Voron Design 2.4.
func Voron24Definition() *MachineDefinition {
	return &MachineDefinition{
		...
		Capabilities: map[string]interface{}{
			...
			"chamber_temp": map[string]interface{}{
				"min_celsius": 0.0,
				"max_celsius": 0.0, // Passive heated chamber, no active max
				"passive":     true,
			},
