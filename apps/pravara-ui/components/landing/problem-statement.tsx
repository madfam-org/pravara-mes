...
// Pain articulation. Each card mirrors a real complaint we'd expect
// to hear in a discovery call with a small/mid-shop operator. The
// frame is "you know this hurts" → "we know exactly which lever
// fixes it." We don't list the fix here (that's FeatureGrid's job);
// we just make sure the visitor feels seen first.
//
// Order is intentional, mirroring the typical buyer's awareness
// curve: fragmentation (the obvious pain) → invisibility (the
// quieter pain) → traceability (the audit-time pain) → unplanned
// downtime (the budget-eating pain).
