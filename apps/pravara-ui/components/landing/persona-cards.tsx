...
// "Is this for me?" answer card. Three personas keyed to operation
// size — the visitor self-selects which scenario matches their world.
// This is the bridge between "yes this hurts" (problem statement)
// and "here's exactly what you'd use it for" (feature grid).
//
// Why three: 1 leaves people unsure if they fit; 4+ creates
// decision-fatigue. Three is the sweet spot for "small / medium /
// big" comparison and matches the Tulana pricing tiers (Starter /
// Growth / Enterprise).
