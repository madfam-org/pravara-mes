...
// What the platform actually does. Six features, ordered from
// infrastructure ("can it talk to my stuff?") to outcome ("what do I
// get?") — that's the buyer's mental model.
